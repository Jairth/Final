...
class Producto(forms.Form):
    categoria = forms.CharField(label='Categoria', max_length=200, required=True)
    marca = forms.CharField(label='Marca', max_length=200, required=True)
    ...
    precio = forms.CharField(label='Precio', max_length=20, required=True)
