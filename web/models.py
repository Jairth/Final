...
class Producto(models.Model):
    ...
    sku = models.CharField(max_length=20,null=True,default='01')
    nombre = models.CharField(max_length=200)
    descripcion = models.TextField(null=True)
    peso = models.IntegerField(default=0,null=True)
    dimension = models.CharField(max_length=100,null=True,default='01')
    color = models.CharField(max_length=200,null=True,default='01')
